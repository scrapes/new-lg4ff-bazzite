...
Bazzite Deck image layered with the [new-lg4ff](https://github.com/berarma/new-lg4ff)
...
rpm-ostree rebase ostree-unverified-registry:ghcr.io/scrapes/bazzite-lg4ff:stable

# 2. Reboot, then switch to the signed reference
systemctl reboot
rpm-ostree rebase ostree-image-signed:docker://ghcr.io/scrapes/bazzite-lg4ff:stable
systemctl reboot
```
